...
public class Resolver {
	...
	public Resolver(Set<String> classMap, Map<String,List<String>> predicateMap) {
		...
		//System.out.println("this is classList" + classList);
	}
	...
	private boolean unify(String aClause) {
		...
		for ( int i = 0 ; i < aTokens.length; i++){
			...
			String[] aArguments = getArguments(aToken);//得到参数
			String aPredicate = getPredicate(aToken);//得到predicate
					...
					if (willResolve){
						...
						for ( int m = 0; m < newATokens.length; m++){
							...
							if (!newToken.equals(negateQuery(aToken))){
								//System.out.println("=-=-=-=-=-=-=--= " + aToken + "-=-=-=-=-=" + newToken);
						...
						//System.out.println("test1111111 +  " + newA);
						...
						//System.out.println("test2222222 +  " + newB);
						...
						//System.out.println("this is new String + ====" + newString);
